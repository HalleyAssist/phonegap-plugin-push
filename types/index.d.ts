...
declare namespace PhonegapPluginPush {
	...
	interface PushNotification {
        ...
        /*TODO according to js source code, "errorHandler" is optional, but is "count" also optional?
          I can't read objetive-C code (can anyone at all? I wonder...)
        ...
        /*
         * Tells the OS to clear the notification with 'notId' from the Notification Center
         ...
         * @param notId The id of the notification to be removed.
         */
		clearNotification(successHandler: () => any, errorHandler: () => any, notId: string): void;
	}
	...
	interface NotificationEventAdditionalData {
		...
		foreground?: boolean;
        /*
		 * Will be true if the application is started by clicking on the push notification,
		 * false if the app is already started. (Android/iOS only)
		 */
		coldstart?: boolean;
		collapse_key?: string;
		from?: string;
...
declare const PushNotification: PhonegapPluginPush.PushNotificationStatic;
